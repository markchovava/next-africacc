...
export default function SectorOpportunityList({ dbData, sectorsData, slug}) {
    ...
    async function getData() {
      try{
        const result = await axios.get(`${baseURL}opportunity-by-sector-slug?sector_slug=${slug}`)
        .then((response) => {
          setData(response.data.data)
          setPrevURL(response.data.links.prev)
          setNextURL(response.data.links.next)
    ...
    async function searchData() {
      ...
      try{
        const result = await axios.get(`${baseURL}opportunity-by-sector-slug?sector_slug=${slug}&search=${search}`)
        .then((response) => {
          setData(response.data.data)
          setPrevURL(response.data.links.prev)
          setNextURL(response.data.links.next)
