  ...
  return (
    ...
    <section className='w-[100%]'>
        <ul className='mx-auto py-1 w-[90%] border-y border-slate-300 flex items-center justify-start gap-1'>
            ...
            <li><MdOutlineChevronRight /></li>
            <li><Link href={`/admin/testimonial`}>Testimonial</Link></li>
            <li><MdOutlineChevronRight /></li>
            <li><Link href={`/admin/testimonial/${id}`} className='font-semibold'>View Testimonial</Link></li>
        </ul>
    </section>
