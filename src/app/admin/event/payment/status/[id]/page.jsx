...
import AttendStatusEdit from "./components/AttendStatusEdit";
  ...
  return (
    ...
    <section className='w-[100%]'>
        <ul className='mx-auto py-1 w-[90%] border-y border-slate-300 flex items-center justify-start gap-1'>
            ...
            <li><MdOutlineChevronRight /></li>
            <li><Link href={`/admin/event/payment/status/${id}`} className='font-semibold'>Event Payment Status</Link></li>
        </ul>
    </section>
    ...
    <section className='w-[100%]'>
      <div className='w-[90%] mx-auto flex items-center justify-center'>
        ...
        Event Payment Status</h6>
      </div>
    </section>

    {/*  */}
    <AttendStatusEdit id={id} />
