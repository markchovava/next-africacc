  ...
  return (
    ...
    <section className='w-[100%]'>
        <ul className='mx-auto py-1 w-[90%] border-y border-slate-300 flex items-center justify-start gap-1'>
            ...
            <li><MdOutlineChevronRight /></li>
            <li><Link href={`/admin/membership/order`}>Membership Subscriptions</Link></li>
            <li><MdOutlineChevronRight /></li>
            <li><Link href={`/admin/membership/order/${id}`} className='font-semibold'>
              View Membership Subscription</Link></li>
        </ul>
    </section>
    ...
    <section className='w-[100%]'>
      <div className='w-[90%] mx-auto flex items-center justify-center'>
        ...
        View Membership Subscription</h6>
      </div>
    </section>
