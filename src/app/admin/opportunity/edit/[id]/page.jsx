...
import OpportunityAdd from './components/OpportunityEdit'
  ...
  return (
    ...
    <section className='w-[100%]'>
        <ul className='mx-auto py-1 w-[90%] border-y border-slate-300 flex items-center justify-start gap-1'>
            ...
            <li><MdOutlineChevronRight /></li>
            <li><Link href={`/admin/opportunity/edit/${id}`} className='font-semibold'>Edit Opportunity</Link></li>
        </ul>
    </section>
